...
global.authFile = `FantasmaBotSession`
...
return { conversation: "hello, i'm FantasmaBotLite-MD" }},   
msgRetryCounterMap,
logger: pino({ level: 'silent' }),
auth: state,
browser: ['FantasmaBotLite-MD','Edge','107.0.1418.26'],
version   
}       
...
let prekey = []
let directorio = readdirSync("./FantasmaBotSession")
...
const directories = ['./FantasmaBotSession/', './FantasmaJadiBot/']
