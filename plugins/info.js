...
const isCommand8 = /^(info(fantasmin|bot)|informaci(ón|on)(fantasmin|bot))$/i.test(command) 
...
let replit = `*◎ R E P L I T*\n\nhttps://replit.com/@fantasmasexo/FantasmaBotLite`
...
description = official[0][0] == String(contact[0]) ? 'Solo temas de FantasminBot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/fantasmasexo' : official[1][0] == String(contact[0]) ? 'https://github.com/elrebelde21' : official[2][0] == String(contact[0]) ? 'https://github.com/Azami19' : official[3][0] == String(contact[0]) ? 'https://github.com/Abiguelreyes75' : md    
...
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'fantasminbot@gmail.com' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
